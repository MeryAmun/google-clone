...
const SearchPageHeader = ({ searchTerm }) => {
  ...
  return (
    <div className="searchPage__header">
        ...
        <div className="searchPageHeader__linksLeft">
          ...
          >
            {active === "Videos" ? (
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <path clipRule="evenodd" fill="#969BA1"></path>
                <path
                  fill="#969BA1"
                  clipRule="evenodd"
          ...
          <div className="searchPageHeader__moreMenu">
            ...
            >
              ...
              >
                <Link
                  to={`https://www.google.com/maps/search/${searchTerm}/@4.0690441,9.6992774,13z/data=!3m1!4b1?hl=en`}
                >
              ...
              >
                <Link
                  to={`https://www.google.com/finance/?sa=X&ved=2ahUKEwiGh-Pbt879AhW5_7sIHX1DDW0Q_AUoAXoECAEQCw`}
                >
                  <svg focusable="false" viewBox="0 0 24 24">
                    <path
                      fill="#969BA1"
      ...
      <Link to="#" className="searchPageHeader__headerLinksRight_safeSearch">
        SafeSearch on
      </Link>
    </div>
  );
