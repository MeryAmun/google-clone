      ...
      <div className="searchPage__results">
        {term && (
          <p className="searchPage__resultCount">
            {searchResults?.searchInformation?.formattedTotalResults} results (
            {searchResults?.searchInformation?.formattedSearchTime} seconds) for{" "}
            {term}
          </p>
        )}
